...
namespace Penna.Assessment.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        [ActionName("Create")]
        public ActionResult Insert([Bind(Exclude = "Id")] UserViewModel viewModel)
        {
            ...
            var user = new User
            {
                ...
                CorporateClientId = viewModel.CorporateClientId
            };
        ...
        public ActionResult Update(UserViewModel viewModel)
        {
            ...
            user.CorporateClientId = viewModel.CorporateClientId;
