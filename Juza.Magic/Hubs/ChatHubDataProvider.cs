...
{
    public interface IChatHubDataProvider
    {
    ...
    public class ChatHubDataProvider : IChatHubDataProvider
    {
        private readonly IDbContext _context;
        private readonly IHubContext<ChatHub> _chatHub;

        public ChatHubDataProvider(IDbContext context, IHubContext<ChatHub> chatHub)
        {
            _context = context;
            _chatHub = chatHub;
        }
