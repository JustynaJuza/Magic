    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.PlayerCardDecks", t => new { t.DeckId, t.UserId, t.GameId }, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.Card_Id, t.ManaColor_Id })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ManaColors", "CardDeck_Id", "dbo.CardDecks");
            ...
            DropForeignKey("dbo.CardManaColors", "ManaColor_Id", "dbo.ManaColors");
            DropForeignKey("dbo.CardManaColors", "Card_Id", "dbo.Cards");
            DropForeignKey("dbo.CardAbilities", "Card_Id", "dbo.Cards");
            DropForeignKey("dbo.ManaColors", "CardAbility_Id", "dbo.CardAbilities");
            ...
            DropIndex("dbo.ManaColors", new[] { "CardDeck_Id" });
            ...
            DropIndex("dbo.CardManaColors", new[] { "ManaColor_Id" });
            DropIndex("dbo.CardManaColors", new[] { "Card_Id" });
            DropIndex("dbo.CardAbilities", new[] { "Card_Id" });
            DropIndex("dbo.ManaColors", new[] { "CardAbility_Id" });
            DropTable("dbo.CardSubTypeCardMainTypes");
            DropTable("dbo.CardManaColors");
