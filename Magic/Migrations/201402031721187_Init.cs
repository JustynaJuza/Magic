    ...
    public partial class Init : DbMigration
    {
        ...
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.ChatLogs", t => t.Log_DateCreated)
                .ForeignKey("dbo.AspNetUsers", t => t.Recipient_Id)
                .ForeignKey("dbo.AspNetUsers", t => t.Sender_Id)
                .Index(t => t.Log_DateCreated)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ChatMessages", "Log_DateCreated", "dbo.ChatLogs");
            ...
            DropIndex("dbo.ChatMessages", new[] { "Log_DateCreated" });
